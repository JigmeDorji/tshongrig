...
assetSetup = (function () {
        ...
        function saveAssetClass() {
            ...
            perClickSubmissionValidatorHandler('#btnSaveDescriptionId', '.assetClassForm', baseURL() + '/saveAssetClass', (res) => {
                if (res.status === 1) {
                    successMsg(res.text);
                    loadDescriptionList();
                } else {
        ...
        function saveAssetSubClassCategories() {
            perClickSubmissionValidatorHandler('#btnSave', '#assetSetupForm', baseURL() + '/saveAssetSubClassCategories', (res) => {
                if (res.status === 1) {
                    successMsg(res.text);
                    $('#particular').val('');
                    getFixedAssetDetail();
        ...
        //             submitHandler: function (form) {
        //                 $(this).attr('disabled', true); // Disable the button immediately
        //                 $.ajax({
