...
assetBuying = (function () {
        ...
        function returnRow() {
            iterator = iterator + 1;
            return "<tr>" +
                "<td><input type='text' readonly class='form-control form-control-sm rowNumber'>" +
                "<input type='hidden'  id='assetDetailId" + iterator + "' name='openingAndBuyingListDTO[0].assetDetailId'  class='form-control form-control-sm assetDetailId'></td>" +
                "<td>" +
                "<input type='hidden' id='faPurchaseId' name='openingAndBuyingListDTO[0].faPurchaseId'  class='form-control form-control-sm faPurchaseId'>" +
                "<input type='text' id='autoCompleteId" + iterator + "' class='form-control form-control-sm particular' name='openingAndBuyingListDTO[0].particular'>" +
                "</td>" +
                "<td><input type='text'  name='openingAndBuyingListDTO[0].rate' class='form-control form-control-sm rate'></td>" +
                "<td><input type='text'  name='openingAndBuyingListDTO[0].qty' class='form-control form-control-sm qty right-align'></td>" +
                "<td><input type='text' readonly name='openingAndBuyingListDTO[0].totalAmount' class='form-control form-control-sm  totalAmount right-align'></td>" +
        ...
        function _disPlayData(data) {
            if (data.status === 1) {
                ...
                for (let i = 0; i < res.length; i++) {
                    ...
                    let row = "<tr>" +
                        "<td><input type='text' id='index' readonly class='form-control form-control-sm' value='" + parseInt(i + 1) + "'>" +
                        "<input type='hidden' id='index' name='purchaseDTOS[" + i + "].type'  class='form-control form-control-sm' value='" + res[i].type + "'>" +
                        "<input type='hidden' id='index' name='purchaseDTOS[" + i + "].purchaseId'  class='form-control form-control-sm' value='" + res[i].purchaseId + "'>" +
                        "<input type='hidden' id='index' name='purchaseDTOS[" + i + "].purchaseAuditId'  class='form-control form-control-sm' value='" + res[i].purchaseAuditId + "'>" +
                        "<input type='hidden' id='brandName' name='purchaseDTOS[" + i + "].brandName'  class='form-control form-control-sm' value='" + res[i].brandName + "'>" +
                        "<input type='hidden' id='prefixCode' name='purchaseDTOS[" + i + "].prefixCode'  class='form-control form-control-sm' value='" + res[i].prefixCode + "'>" +
                        "<input type='hidden' id='index' name='purchaseDTOS[" + i + "].locationId'  class='form-control form-control-sm' value='" + res[i].locationId + "'></td>" +
                        "<td><input type='text' id='itemCode' readonly name='purchaseDTOS[" + i + "].itemCode' class='form-control form-control-sm' value='" + res[i].itemCode.toUpperCase() + "'></td>" +
                        "<td><input type='text' readonly name='purchaseDTOS[" + i + "].itemName' class='form-control form-control-sm' value='" + res[i].itemName + "'></td>" +
                        "<td><input type='text' readonly name='purchaseDTOS[" + i + "].partNo' class='form-control form-control-sm partNo' value='" + res[i].partNo + "'></td>" +
                        "<td><input type='text' readonly name='purchaseDTOS[" + i + "].sellingPrice' class='form-control form-control-sm sellingPrice right-align' value='" + res[i].sellingPrice + "'></td>" +
                        "<td><input type='text' readonly name='purchaseDTOS[" + i + "].costPrice' class='form-control form-control-sm costPrice right-align' value='" + res[i].costPrice + "'></td>" +
                        "<td><input type='hidden' id='initialQty' readonly class='form-control form-control-sm initialQty right-align'><input type='text' id='qty' readonly class='form-control form-control-sm qty right-align amount'   name='purchaseDTOS[" + i + "].qty' value=" + res[i].qty + " ></td>" +
                        "<td><input type='hidden' readonly name='purchaseDTOS[" + i + "].unitId' class='form-control form-control-sm costPrice right-align' value='" + res[i].unitId + "'><input type='text' readonly  class='form-control form-control-sm costPrice right-align' value='" + res[i].unitName + "'></td>" +
                        "<td><input type='text' readonly class='form-control form-control-sm totalAmount right-align totalAmount' id='totalAmount'  name='purchaseDTOS[" + i + "].totalAmount' value=" + res[i].costPrice + " ></td>" +
