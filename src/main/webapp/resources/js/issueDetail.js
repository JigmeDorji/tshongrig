/**
 * Created by Bikash Rai on 9/18/2021.
 */
...
$(document).ready(function () {
    issueDetail.getSaleList();
    issueDetail.getSaleDetailView();
    issueDetail.deleteSaleRelatedVoucher();
    issueDetail.onchangeDateRange();
});