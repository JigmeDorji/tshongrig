...
<div class="page_title">
    ...
    <span class="subtitle">Adjustment</span>
</div>
<form id="adjustmentForm" action="<c:url value='/adjustment'/> " class="form-horizontal adjustmentForm">
    <fieldset>
        <legend>Voucher</legend>
        <input type="hidden" class="form-control" id="ledgerId" name="ledgerId">
        <input type="hidden" class="form-control" id="expenditureHiddenText">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" class="form-control" id="adjustedAgainst" name="adjustedAgainst" required>
            </div>
        </div>
        <div class="form-group costContent hidden">
            ...
            <div class="col-md-3">
                <select class="form-control select2 costType" id="costType" style="width:100%;"
                        name="costId">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <form:select class="form-control select2" name="adjustedFrom" path="adjustedFormList"
