...
<div class="page_title">
    ...
    <span class="subtitle">Ledger Details</span>
</div>
...
<form id="voucherListForm" action="<c:url value='/voucherGroupList'/>" class="form-horizontal globalForm">
    ...
    <fieldset>
        ...
        <div class="form-group">
            <label class="col-md-2  right-label">&nbsp;<b>Ledger Name:</b></label>

            <div class="col-md-3">
                <input type="text" class="form-control resetfield"
                       readonly id="ledgerName"/>
            </div>

            <label class="col-md-1 right-align required col-md-offset-1">From</label>
            <div class="col-md-2">
                <input type="text" tabindex="2" class="form-control  datepicker right-align dateRange"
                       id="fromDate"/>
            </div>
            <label class="col-md-1 right-align required">To</label>
            <div class="col-md-2">
                <input type="text" tabindex="2" class="form-control right-align datepicker dateRange"
                       id="toDate"/>
            </div>
        </div>
        <div class="partyDetail hidden">
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" tabindex="4" class="form-control resetfield" name="partyAddress" readonly
                           id="partyAddress"/>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" tabindex="5" class="form-control resetfield" readonly
                           name="partyContactNo"
                           id="partyContactNo"/>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" tabindex="6" class="form-control resetfield" name="partyEmail" readonly
                           id="partyEmail"/>
                </div>
            </div>
                ...
                <table class="table table-bordered table-hover" id="voucherListGrid">
                    ...
                    <tr>
                        ...
                        <td style="border-top: dotted">
                            <input type="text" class="form-control openingBalance  right-align"
                                   style="border-radius: 0;height: 28px !important;" readonly>
                        </td>
                        <td style="border-top: dotted;border-right: dotted;">
                            <input type="text" class="form-control openBalanceAmount  right-align"
                                   style="border-radius: 0;height: 28px !important;" readonly>
                        </td>
                    ...
                    <tr>
                        ...
                        <td hidden="hidden"></td>
                        <td><input type="text" class="form-control   right-align"
                    ...
                    <tr id="retainedEarningArea" hidden>
                        ...
                        <td hidden="hidden"></td>
                        <td><input type="text" class="form-control   right-align"
                                   style="border-radius: 0;height: 28px !important;" id="retainedEarningDr" readonly></td>
                        <td style="border-right: dotted;">
                            <input type="text"
                                   class="form-control   right-align"
                                   style="border-radius: 0; height: 28px !important;"
        ...
        <div class="col-sm-offset-8  col-md-4 " style="padding-left: 4.5%">
            <input type="button" tabindex="4" class="btn btn-primary btn-block hidden" value="Reconcil Bank Amount"
    ...
    <div id="reconciliationShow" hidden>
        <fieldset>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" class="form-control resetfield right-align" name="bookBalance"
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" class="form-control resetfield right-align" value="0"
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" tabindex="3" class="form-control resetfield right-align" name="directDeposit"
                           value="0"
                           id="directDeposit">
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" tabindex="4" class="form-control resetfield right-align" name="directTransfer"
                           value="0"
                           id="directTransfer"/>
                </div>
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" tabindex="5" class="form-control resetfield right-align" value="0"
            ...
            <div class="form-group">
                ...
                <div class="col-md-3">
                    <input type="text" tabindex="6" class="form-control resetfield right-align"
