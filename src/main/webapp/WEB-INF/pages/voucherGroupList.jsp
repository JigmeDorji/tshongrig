            ...
            <form id="voucherListForm" action="<c:url value='/voucherGroupList'/>" class="form-horizontal globalForm">
                ...
                <fieldset>
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input type="text" tabindex="2" class="form-control form-control-sm  datepicker right-align dateRange"
                                   id="fromDate"/>
                        </div>
                        <label class="col-md-1 right-align ">To</label>
                        <div class="col-md-2">
                            <input type="text" tabindex="2" class="form-control form-control-sm right-align datepicker dateRange"
                                   id="toDate"/>
                        </div>
                    </div>
                            ...
                            <table class="table  table-hover" id="voucherListGrid">
                                ...
                                <tr>
                                    ...
                                    <td style="border-top: dotted">
                                        <input type="text" class="form-control form-control-sm openingBalance  right-align"
                                               style="border-radius: 0;height: 28px !important;" readonly>
                                    </td>
                                    <td style="border-top: dotted;border-right: dotted;">
                                        <input type="text" class="form-control form-control-sm openBalanceAmount  right-align"
                                               style="border-radius: 0;height: 28px !important;" readonly>
                                    </td>
                ...
                <div id="reconciliationShow" hidden>
                    <fieldset>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control form-control-sm resetfield right-align" name="bookBalance"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input type="text" tabindex="3" class="form-control form-control-sm resetfield right-align"
                                       name="directDeposit"
                                       value="0"
                                       id="directDeposit">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input type="text" tabindex="4" class="form-control form-control-sm resetfield right-align"
                                       name="directTransfer"
                                       value="0"
                                       id="directTransfer"/>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input type="text" tabindex="5" class="form-control form-control-sm resetfield right-align" value="0"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <input type="text" tabindex="6" class="form-control form-control-sm resetfield right-align"
