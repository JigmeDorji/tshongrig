    ...
    <div class="card">
        <div class="card-body">
            <form id="returnItemForm" action="<c:url value='/openingBalanceInventory'/> " class="form-horizontal globalForm">
                ...
                <input type="hidden" id="isOpeningEntry" class="form-control form-control-sm " name="isOpeningEntry" value="Y">
                ...
                <fieldset>
                    ...
                    <div class="form-group row">
                        <div class="col-md-3">
                            <input type="hidden" id="purchaseInvoiceNo" class="form-control form-control-sm " name="purchaseInvoiceNo"
                                   value="0"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-3">
                            <input type="hidden" id="type" class="form-control form-control-sm "
                                   required="required" name="purchaseDTOS[0].type" value="Material"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input type="hidden" tabindex="2" class="form-control form-control-sm  right-align"
                                   id="partNo" name="purchaseDTOS[0].partNo" value="MA000"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-4" style="margin-left: -30px">
                            <input type="text" id="itemName" class="form-control form-control-sm common" name="purchaseDTOS[0].itemName"
                                   required="required"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-1">
                            <input type="text" id="qty" class="form-control form-control-sm amount common" name="purchaseDTOS[0].qty" required="required"/>
                        ...
                        <div class="col-md-1">
                            <form:select class="form-control form-control-sm resetField" path="unitList" id="unitId" required="required"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input type="text" id="costPrice" class="form-control form-control-sm amount common" name="purchaseDTOS[0].costPrice"
                                   required="required"/>
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        <div class="col-md-3">
                            <input type="hidden" id="sellingPrice" class="form-control form-control-sm amount common"
                                   required="required"
                                   name="purchaseDTOS[0].sellingPrice" value="0.0"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            ...
                            <form:select class="form-control form-control-sm resetField common" path="locationList" id="locationId"
                                         required="required"
                        ...
                        <form id="supplierSetupForm" action="<c:url value='/supplierSetup'/> " class="form-horizontal supplierForm">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-3">
                                        <input type="text" tabindex="4" class="form-control form-control-sm" id="email" required="required"
                                               name="email"/>
                                    </div>
                                </div>
                                ...
                                <div class="modal-body">
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <input type="text" required class="form-control form-control-sm" id="brandName" name="brandName">
                                        </div>
                                        <div class="form-group row ">
                                            <label for="brandPrefix" class="col-form-label">Brand Prefix</label>
                                            <input type="text" required class="form-control form-control-sm" id="brandPrefix" name="brandPrefix">
                                        </div>
                                        <div class="form-group row">
