...
<form id="returnItemForm" action="<c:url value='/openingBalanceInventory'/> " class="form-horizontal globalForm">
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <input type="text" tabindex="2" class="form-control datepicker formatDate right-align" value="${currentUser.financialYearFrom}"
        ...
        <div class="form-group">
            <div class="col-md-3">
                <input type="hidden" id="sellingPrice" class="form-control amount common"
                       required="required"
