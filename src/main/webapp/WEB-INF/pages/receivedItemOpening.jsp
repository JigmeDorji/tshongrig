            ...
            <form id="returnItemForm" action="<c:url value='/openingBalanceInventory'/> " class="form-horizontal globalForm">
                ...
                <fieldset>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input type="text" tabindex="2" class="form-control form-control-sm  right-align" value="${currentUser.financialYearFrom}"
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-2">
                            <input type="button" data-toggle="modal" class="btn btn-sm btn-primary btn-xs" value="New Brand"
                                   id="btnAddBrand">
                        </div>
