...
<div class="page_title">
    ...
    <span class="subtitle">Employee Setup</span>
</div>
<form id="itemSetupFrom" action="<c:url value='/employeeSetup'/> " class="form-horizontal globalForm">
    ...
    <fieldset class="v-no-padding">
        <legend>Employee detail list</legend>
        <div class="form-group">
            <button type="button" class="btn btn-primary col-lg-offset-11" id="btnAddNewEmp">Add New</button>
        </div>
        <div class="form-group">
            <div class="col-md-12">
                <table class="table table-bordered table-striped editable-grid" Id="employeeSetUpList">
                    <thead>
                    <tr>
                        <th width="5%">Srl</th>
                        <th class="hidden"></th>
                ...
                <div class="modal-body">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" tabindex="1" maxlength="50" class="form-control resetfield" name="empName"
                            ...
                            <div class="col-md-3">
                                <input type="text" tabindex="2" class="form-control  dateFormat2 right-align resetfield"
                                       placeholder="DD.MM.YYYY"  name="dateOfBirth" id="dateOfBirth" required="required"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" tabindex="2" maxlength="11" class="form-control resetfield" name="cidNo"
                                       id="cidNo" required="required"/>
                            </div>
                            <label class="col-md-2 right-align required">Contact No.</label>

                            <div class="col-md-3">
                                <input type="text" tabindex="8" maxlength="8" class="form-control resetfield" name="contactNo"
                                       id="contactNo"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield" name="tpnNo" id="tpnNo"/>
                            </div>

                            <label class="col-md-2 right-align required">Date of appointment/Joining service </label>

                            <div class="col-md-3">
                                <input type="text" class="form-control  dateFormat2 right-align resetfield" name="dateOfAppointment"
                                       required="required"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield right-align" name="basicSalary" required="required"
                                       id="basicSalary"/>
                            </div>
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield" name="post" id="post"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield right-align" name="incrementAmount"
                                       id="incrementAmount"/>
                            </div>
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control dateFormat2 resetfield right-align" name="incrementEffectDate"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <form:select class="form-control resetfield" name="serviceType" path="serviceTypeList"
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield right-align" name="allowance"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield" name="emailAddress"
                                       id="emailAddress"/>
                            </div>
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield" name="village" required="required"
                                       id="village"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield" name="gewog" required="required"
                                       id="gewog"/>
                            </div>
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield" name="dzongkhag" required="required"
                                       id="dzongkhag"/>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield" name="accNo" required="required"
                                       id="accNo"/>
                            </div>
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield amount " name="pF" readonly required="required"
                                       id="pF"/>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3">
                                <input type="text" class="form-control resetfield amount" name="gIS"
                                       id="gIS"/>
                            </div>
