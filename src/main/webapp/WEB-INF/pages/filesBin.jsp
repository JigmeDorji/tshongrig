...
<html>
<title class="title"> View Deleted Files </title>
<body>
<!-- Page header -->
    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                <a href="." class="breadcrumb-item"><i class="icon-home2 mr-2"></i> Bin</a>
                <span class="breadcrumb-item active">Deleted  Files</span>
            </div>
                    ...
                    <c:if test="${files.size()>0}">
                        <c:forEach items="${files}" var="file">
                            ...
                            <tr>
                                ...
                                <td>${file.fileName}</td>
                                <td><fmt:formatDate type="date" value="${file.movedToBinDate}" pattern="dd/MM/yy"/></td>
                                <td>
                                    <button class="btn btn-info btn-sm onViewBtn" data-id="${file.id}">View</button>

                                    <button class="onRetrieveBtn btn btn-warning btn-sm" id="${file.id}"
                                            accesskey="${file.id}">Retrieve
                                    </button>
                                </td>
                            </tr>
                        </c:forEach>
...
<%--                                    <input type="button" tabindex="9" class="onRetrieveBtn btn btn-sm btn-primary"--%>
<%--                                           value="Retrieve" id="onRetrieveBtn">--%>
                                </div>
                                <div class="mx-2">
                                    <input type="button" tabindex="9" class="btn btn-sm btn-info" value="Print"
                                           id="onPrintBtn">
                                </div>
                                <div class="mx-2">
                                    <input type="submit" tabindex="9" class="onPermanentlyDelBtn btn btn-sm btn-danger"
                                           value="Delete" id="onPermanentlyDelBtn">
                                </div>
