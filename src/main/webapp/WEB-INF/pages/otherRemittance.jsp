...
<html>
<title class="title">Other Remittance</title>

<body>
<div class="page_title">
    <span class="title">Human Resource</span>
    <span class="subtitle">Other Remittance</span>
</div>
<form id="folktaleCreationFrom" action="<c:url value='/otherRemittance'/> " class="form-horizontal globalForm">
    <fieldset>
        <legend>Statutory Remittance</legend>
    ...
    <fieldset class="v-no-padding">
        <legend>Statutory detail</legend>
        <div class="form-group">
            <div class="col-md-12 table-responsive">
                <table class="table table-bordered table-striped editable-grid" Id="otherRemittanceGrid">
                    <thead>
                    <tr>
                        <th class="hidden"></th>
                        <th width="30%">Name</th>
                    ...
                    <tr>
                        ...
                        <th></th>
                        <th>Total</th>
                        <th><input class="form-control text-center totalPF"  readonly name="pF" value="0"></th>
                        <th><input class="form-control text-center totalGIS" readonly name="gIS" value="0"></th>
                        <th><input class="form-control text-center grandAmt"  readonly name="totalAmount" value="0"></th>
                    </tr>
                    </tfoot>
                </table>
            </div>
        ...
        <div class="form-group">
            ...
            <div class=" col-md-2">
                <input type="submit" class="btn btn-primary btn-block " value="Remit" id="otherRemitBtn">
            </div>
        </div>
    </fieldset>
</form>
