...
<div class="page_title">
    ...
    <span class="subtitle">Asset Setup</span>
</div>
<form id="assetSetupForm" action="<c:url value='/assetSetup'/> " class="form-horizontal globalForm">
    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-md-1">
                <input type="button" data-toggle="modal" class="btn btn-primary btn-xs" value="Add Particular"
                       id="btnAddParticular">
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                <textarea type="text" tabindex="2" class="form-control  right-align common" required
    ...
    <fieldset class="hidden" id="initialTable">
        <legend>Asset Setup Detail</legend>
        <br/>
        <div class="col-md-12">
                ...
                <div class="modal-body">
                    <form>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <form:select class="form-control resetfield" name="groupId"
                                             path="groupList"
                                             id="groupId">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="modalParticular" readonly>
                    </div>
                ...
                <fieldset>
                    <legend>Asset Transaction Detail</legend>
                    <div class="form-group">
                        <table class="table table-bordered table-striped editable-grid"
                               Id="assetTxnGrid">
                            <thead>
