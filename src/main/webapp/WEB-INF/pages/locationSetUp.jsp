...
<html>
<title class="title">Location Setup</title>
...
<div class="content">
    ...
    <div class="card">
        <div class="card-body">
            <form id="folktaleCreationFrom" action="<c:url value='/locationSetUp'/>" class="globalForm">
                ...
                <fieldset>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input type="text" tabindex="1" maxlength="50" class="form-control form-control-sm resetfield" name="locationId"
                                   id="locationId" required="required"/>
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-md-3">
                            <input type="text" tabindex="1" maxlength="50" class="form-control form-control-sm resetfield" name="description"
