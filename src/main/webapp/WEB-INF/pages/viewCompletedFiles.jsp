...
<%--                                    <button class="onDeleteBtn btn btn-danger btn-sm" id="deleteBtn"--%>
...
<%--                                <div class="mx-2">--%>
<%--                                    <input type="button" tabindex="9" class="btn btn-sm btn-primary"--%>
<%--                                           value="Mark as Completed" id="onMarkedAsCompletedBtn">--%>
<%--                                </div>--%>
                                <div class="mx-2">
                                ...
                                <div class="mx-2">
<%--                                    <input type="submit" tabindex="9" class="onDeleteBtn btn btn-sm btn-danger"--%>
<%--                                           value="Delete" id="onDeleteBtn">--%>
                                    <input type="submit" tabindex="9" class="returnBtn btn btn-sm btn-success"
                                           value="Return" id="returnBtn">
                                </div>
