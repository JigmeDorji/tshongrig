...
<div class="page_title">
    ...
    <span class="subtitle">Money Receipt</span>
</div>
<form id="registrationForm" action="<c:url value='/moneyReceipt'/> " class="form-horizontal globalForm">
    <fieldset>
        <legend>Money Receipt Generation</legend>
        <div class="form-group">
            <label class="col-md-3 text-right required">Receipt No.</label>

            <div class="col-md-4">
                <input type="text" tabindex="1" class="form-control resetfield" name="receiptNo" readonly
                       id="receiptNo" value="${moneyReceiptNo}" required="true"/>
            </div>
        </div>

        <div class="form-group">
            <label class="col-md-3 text-right required">Receipt Date </label>

            <div class="col-md-4">
                <input type="text" tabindex="2" class="form-control  formatDate " value="${currentDate}"
                       placeholder="DD.MM.YYYY" id="receiptDate" name="receiptDate" required="required" readonly/>
            </div>
        </div>

        <div class="form-group">
            <label class="col-md-3 text-right required">Received with thanks from </label>

            <div class="col-md-4">
                <form:select class="form-control select2 resetField" path="partyList" id="partyLedgerId"
                             required="required"
                             name="partyLedgerId">
        ...
        <div class="form-group">
           ...
           <%-- <label class=" col-md-1 left-label">TDS %</label>
            ...
            <div class="col-md-1">
                <input type="text" tabindex="1" class="form-control  amount" readonly
            ...
            <div class="col-md-2">
                <input type="text" tabindex="1" class="form-control  amount" readonly name="tDSAmount"
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" tabindex="1" class="form-control  amount" name="retentionAmount"
                       id="retentionAmount"/>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" tabindex="1" class="form-control  amount" name="mobilizationAdvAmount"
                       id="mobilizationAdvAmount"/>
            </div>
            <label class=" col-md-1 left-label">Party</label>

            <div class="col-md-4">
                <form:select class="form-control select2 resetField" path="mobilizationAdvPartyList" id="mobilizationAdvPartyLedgerId"
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <input type="text" tabindex="1" class="form-control  amount" name="materialAdvAmount"
                       id="materialAdvAmount"/>
            </div>
            <label class=" col-md-1 left-label">Party</label>

            <div class="col-md-4">
                <form:select class="form-control select2 resetField" path="materialAdvPartyList" id="materialAdvPartyLedgerId"
        ...
        <div class="form-group">
            ...
            <div class="col-md-4">
                <select class="form-control select2 resetField" id="isCash" required="required"
                        name="isCash">
                    <option value="">---Please Select---</option>
