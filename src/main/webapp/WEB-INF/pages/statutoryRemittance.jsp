...
<div class="page_title">
    ...
    <span class="subtitle">Statutory Remittance</span>
</div>
<form id="folktaleCreationFrom" action="<c:url value='/statutoryRemittance'/> " class="form-horizontal globalForm">
    <fieldset>
            ...
            <div class="col-md-12 table-responsive">
                <table class="table table-bordered table-striped editable-grid" Id="statutoryRemittanceGrid">
                    ...
                    <tr>
                        ...
                        <th></th>
                        <th>Total</th>
                        <th><input class="form-control text-center tDS"  readonly name="tDS" value="0"></th>
                        <th><input class="form-control text-center hC"  readonly name="hC" value="0"></th>
