...
public class LedgerGroupListDao {
    ...
    public List<AccProfitAndLossReportDTO> getLedgerGroupList(Integer companyId, Integer accountTypeId, CurrentUser currentUser) {
        String sqlQry = "select ledgerId, particular,sum(amount) as amount,groupId  from \n" +
                "(SELECT b.ledgerId, b.ledgerName as particular, b.openingBal as amount,f.groupId as groupId\n" +
