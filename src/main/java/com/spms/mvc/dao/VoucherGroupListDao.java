...
public class VoucherGroupListDao {
        ...
        @Transactional
        public List<AccProfitAndLossReportDTO> getVoucherDetailsByAccTypeAndLedgerType(String ledgerId, Date currentPeriodFrom, Date currentPeriodTo, Date fromDate, Date toDate, Integer companyId) {
                String sqlQry = "call sp_acc_view_ledger_Details(:ledgerId,:currentPeriodFrom,:currentPeriodTo,:companyId);";
                return sessionFactory.getCurrentSession().createSQLQuery(sqlQry)
