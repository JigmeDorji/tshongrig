...
/**
 * Description: AdjustmentController
 * Date:  2022-Jan-23
 *
 * @author: Bikash Rai
 * @version: 1.0.0
...
public class AdjustmentController extends BaseController {
    ...
    public String list(Model model, HttpServletRequest request) {
        ...
        model.addAttribute("adjustedFormList", autoVoucherService.getAllLedgerUnderAccountType(getCurrentUser(request),
    ...
    @ResponseBody
    @RequestMapping(value = "/adjustmentDetail", method = RequestMethod.POST)
    public ResponseMessage adjustmentDetail(HttpServletRequest request, AutoVoucherDTO autoVoucherDTO) throws
            IOException, ParseException {
        autoVoucherDTO.setTypeId(1);
        CurrentUser currentUser = (CurrentUser) request.getSession().getAttribute("currentUser");
        return autoVoucherService.adjustmentDetail(autoVoucherDTO, currentUser);
    }
    ...
    @ResponseBody
    @RequestMapping(value = "/getAmountByLedgerId", method = RequestMethod.GET)
    public Double getAmountByLedgerId(HttpServletRequest request, String ledgerId) {
